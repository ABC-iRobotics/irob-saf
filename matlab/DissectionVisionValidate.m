classdef DissectionVisionValidate < handle
    ...
    properties
        ...
        retractor_ori = [ 0.2381   -0.5135   -0.0223    0.8241];
    ...
    methods
        ...
        function obj = DissectionVisionValidate
           ...
           % figure('units','normalized','outerposition',[0 0 1 1])
            % capture img; choose group loc; choose tgt; get dp; goto tgt dp;
             ...
             [obj.retractor_pos, obj.userInputX, obj.userInputY] = ...
                        XYZ_coordinate_calculation_validation( I_l, I_r, obj.stereoParams, ...
                        400, 0, 25, 25, obj.firstTgt, obj.userInputX, obj.userInputY);
                    
             obj.retractor_pos = obj.retractor_pos + [0.0, -0.05, 0.0]     
