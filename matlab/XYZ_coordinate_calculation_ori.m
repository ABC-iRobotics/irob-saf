function [cuttingXYZ, userInputX, userInputY, meanAnglesCenter, meanAnglesTop] = XYZ_coordinate_calculation_ori( IL, IR, stereoParams, maxDisp, dir, lowThresh, highThresh, firstTgt, userInputX, userInputY)
