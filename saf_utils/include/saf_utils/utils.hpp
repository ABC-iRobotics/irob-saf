...
#ifndef SAF_UTILS_HPP_
#define SAF_UTILS_HPP_
...
#include "saf_msgs/msg/float_array.hpp"
...
#include "saf_msgs/msg/environment.hpp"
...
template <>
inline saf_msgs::msg::FloatArray makeNaN(){
  saf_msgs::msg::FloatArray msg;
...
template <>
inline saf_msgs::msg::ToolPose makeNaN(){
  saf_msgs::msg::ToolPose nanp;
...
template <>
inline saf_msgs::msg::Environment makeNaN(){
  saf_msgs::msg::Environment nanp;
  nanp.valid = saf_msgs::msg::Environment::INVALID;
  return nanp;
}
...
template <>
inline bool isnan(const saf_msgs::msg::ToolPose& d)
{
...
template <>
inline bool isnan(const saf_msgs::msg::Environment& d)
{
  return (d.valid == saf_msgs::msg::Environment::INVALID);
}
