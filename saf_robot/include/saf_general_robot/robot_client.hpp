 ...
 *  planned to be used as members of saf_motion/SurgemeServer.
...
#include <saf_utils/trajectory_factory.hpp>
#include <saf_utils/utils.hpp>
#include <saf_utils/saf_action_client.hpp>
...
private:
  ...
  // Action clients
  SafActionClient<saf_msgs::action::RobotAction> ac;

  // States
  saf_msgs::msg::ToolPoseStamped position_cartesian_current;
  sensor_msgs::msg::JointState joint_state_current;
  saf_msgs::msg::InstrumentInfo instrument_info;

  // Subscribers
  rclcpp::Subscription<saf_msgs::msg::ToolPoseStamped>::SharedPtr position_cartesian_current_sub;
  rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr joint_state_current_sub;
  rclcpp::Subscription<saf_msgs::msg::InstrumentInfo>::SharedPtr instrument_info_sub;

  // Publishers
  rclcpp::Publisher<saf_msgs::msg::ToolPoseStamped>::SharedPtr position_cartesian_current_pub;
...
public:
  ...
  // Callbacks
  void positionCartesianCurrentCB(const saf_msgs::msg::ToolPoseStamped::SharedPtr msg);
  void jointStateCurrentCB(const sensor_msgs::msg::JointState::SharedPtr msg);
  void instrumentInfoCB(const saf_msgs::msg::InstrumentInfo::SharedPtr msg);

  ToolPose getPoseCurrent();
  sensor_msgs::msg::JointState getJointStateCurrent();
  saf_msgs::msg::InstrumentInfo getInstrumentInfo();
  std::string getName();
  ...
  saf_msgs::msg::RobotFeedback getFeedback(bool = true);
  saf_msgs::msg::RobotResult getResult(bool = true);
};
