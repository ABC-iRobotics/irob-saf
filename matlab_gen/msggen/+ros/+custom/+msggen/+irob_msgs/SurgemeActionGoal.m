classdef SurgemeActionGoal < ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'b2c526c0b92cc84e8560dadb66529f95' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsSurgemeGoalClass = ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeGoal') % Dispatch to MATLAB class for message type irob_msgs/SurgemeGoal
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.SurgemeActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.SurgemeActionGoal;
            obj.reload(strObj);
        end
    end
end
