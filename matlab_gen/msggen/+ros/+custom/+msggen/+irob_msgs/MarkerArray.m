classdef MarkerArray < ros.Message
    ...
    properties (Constant, Access = protected)
        IrobMsgsMarkerClass = ros.msg.internal.MessageFactory.getClassForType('irob_msgs/Marker') % Dispatch to MATLAB class for message type irob_msgs/Marker
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.MarkerArray.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.MarkerArray;
            obj.reload(strObj);
        end
    end
end
