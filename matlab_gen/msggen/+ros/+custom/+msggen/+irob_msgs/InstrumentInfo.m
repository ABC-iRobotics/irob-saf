classdef InstrumentInfo < ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '206e2d6e208d9f2dfa130cb16d94871e' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        IrobMsgsInstrumentJawPartClass = ros.msg.internal.MessageFactory.getClassForType('irob_msgs/InstrumentJawPart') % Dispatch to MATLAB class for message type irob_msgs/InstrumentJawPart
    end
    ...
    methods
        ...
        function set.Name(obj, name)
            ...
            validateattributes(name, {'char', 'string'}, {}, 'InstrumentInfo', 'Name');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.InstrumentInfo.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.InstrumentInfo;
            obj.reload(strObj);
        end
    end
end
