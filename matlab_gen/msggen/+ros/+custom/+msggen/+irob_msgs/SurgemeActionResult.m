classdef SurgemeActionResult < ros.Message
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsSurgemeResultClass = ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeResult') % Dispatch to MATLAB class for message type irob_msgs/SurgemeResult
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.SurgemeActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.SurgemeActionResult;
            obj.reload(strObj);
        end
    end
end
