classdef RobotActionGoal < ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'dffcb0890af600863c9e896d0d0a0dc0' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsRobotGoalClass = ros.msg.internal.MessageFactory.getClassForType('irob_msgs/RobotGoal') % Dispatch to MATLAB class for message type irob_msgs/RobotGoal
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.RobotActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.RobotActionGoal;
            obj.reload(strObj);
        end
    end
end
