classdef RobotFeedback < ros.Message
    ...
    methods
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char', 'string'}, {}, 'RobotFeedback', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.RobotFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.RobotFeedback;
            obj.reload(strObj);
        end
    end
end
