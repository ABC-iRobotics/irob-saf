classdef SurgemeGoal < ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '1e6b93455f2a79e37da1430f8f367848' % The MD5 Checksum of the message definition
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.irob_msgs.SurgemeGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.irob_msgs.SurgemeGoal;
            obj.reload(strObj);
        end
    end
end
