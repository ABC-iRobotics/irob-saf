    ...
    methods (Static, Hidden)
        function messageList = getMessageList
            ...
            if isempty(msgList)
                ...
                msgList{5} = 'irob_msgs/GestureAction';
                msgList{6} = 'irob_msgs/GestureActionFeedback';
                msgList{7} = 'irob_msgs/GestureActionGoal';
                msgList{8} = 'irob_msgs/GestureActionResult';
                msgList{9} = 'irob_msgs/GestureFeedback';
                msgList{10} = 'irob_msgs/GestureGoal';
                msgList{11} = 'irob_msgs/GestureResult';
                msgList{12} = 'irob_msgs/GetControlVariablesRequest';
                msgList{13} = 'irob_msgs/GetControlVariablesResponse';
                msgList{14} = 'irob_msgs/GraspObject';
                msgList{15} = 'irob_msgs/InstrumentInfo';
                msgList{16} = 'irob_msgs/InstrumentJawPart';
                msgList{17} = 'irob_msgs/RobotAction';
                msgList{18} = 'irob_msgs/RobotActionFeedback';
                msgList{19} = 'irob_msgs/RobotActionGoal';
                msgList{20} = 'irob_msgs/RobotActionResult';
                msgList{21} = 'irob_msgs/RobotFeedback';
                msgList{22} = 'irob_msgs/RobotGoal';
                msgList{23} = 'irob_msgs/RobotResult';
                msgList{24} = 'irob_msgs/ToolPose';
                msgList{25} = 'irob_msgs/ToolPoseStamped';
                msgList{26} = 'irob_msgs/TrajectoryToolPose';
                msgList{27} = 'irob_msgs/VisionObject';
            end
