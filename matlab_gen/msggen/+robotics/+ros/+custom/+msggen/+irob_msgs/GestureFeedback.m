classdef GestureFeedback < robotics.ros.Message
    %GestureFeedback MATLAB implementation of irob_msgs/GestureFeedback
    ...
    properties (Constant)
        MessageType = 'irob_msgs/GestureFeedback' % The ROS message type
    end
    ...
    methods
        function obj = GestureFeedback(msg)
            %GestureFeedback Construct the message object GestureFeedback
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.IrobMsgsToolPoseClass}, {'nonempty', 'scalar'}, 'GestureFeedback', 'Pose');
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'GestureFeedback', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.GestureFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.GestureFeedback;
            obj.reload(strObj);
        end
    end
end
