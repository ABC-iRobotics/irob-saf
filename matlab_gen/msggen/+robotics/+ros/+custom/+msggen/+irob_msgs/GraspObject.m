classdef GraspObject < robotics.ros.Message
    ...
    methods
        ...
        function set.Name(obj, name)
            ...
            validateattributes(name, {'char'}, {}, 'GraspObject', 'Name');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.GraspObject.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.GraspObject;
            obj.reload(strObj);
        end
    end
end
