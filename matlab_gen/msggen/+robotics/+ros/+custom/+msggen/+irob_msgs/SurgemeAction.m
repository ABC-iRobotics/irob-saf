classdef SurgemeAction < robotics.ros.Message
    ...
    properties (Constant, Access = protected)
        IrobMsgsSurgemeActionFeedbackClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeActionFeedback') % Dispatch to MATLAB class for message type irob_msgs/SurgemeActionFeedback
        IrobMsgsSurgemeActionGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeActionGoal') % Dispatch to MATLAB class for message type irob_msgs/SurgemeActionGoal
        IrobMsgsSurgemeActionResultClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeActionResult') % Dispatch to MATLAB class for message type irob_msgs/SurgemeActionResult
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.SurgemeAction.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.SurgemeAction;
            obj.reload(strObj);
        end
    end
end
