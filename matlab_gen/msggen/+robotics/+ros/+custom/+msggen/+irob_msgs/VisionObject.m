classdef VisionObject < robotics.ros.Message
    ...
    methods
        ...
        function set.Name(obj, name)
            ...
            validateattributes(name, {'char'}, {}, 'VisionObject', 'Name');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.VisionObject.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.VisionObject;
            obj.reload(strObj);
        end
    end
end
