classdef SurgemeFeedback < robotics.ros.Message
    %SurgemeFeedback MATLAB implementation of irob_msgs/SurgemeFeedback
    ...
    properties (Constant)
        MessageType = 'irob_msgs/SurgemeFeedback' % The ROS message type
    end
    ...
    methods
        function obj = SurgemeFeedback(msg)
            %SurgemeFeedback Construct the message object SurgemeFeedback
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.IrobMsgsToolPoseClass}, {'nonempty', 'scalar'}, 'SurgemeFeedback', 'Pose');
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'SurgemeFeedback', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.SurgemeFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.SurgemeFeedback;
            obj.reload(strObj);
        end
    end
end
