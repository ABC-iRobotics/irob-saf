classdef SurgemeActionGoal < robotics.ros.Message
    %SurgemeActionGoal MATLAB implementation of irob_msgs/SurgemeActionGoal
    ...
    properties (Constant)
        MessageType = 'irob_msgs/SurgemeActionGoal' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsSurgemeGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/SurgemeGoal') % Dispatch to MATLAB class for message type irob_msgs/SurgemeGoal
    ...
    methods
        function obj = SurgemeActionGoal(msg)
            %SurgemeActionGoal Construct the message object SurgemeActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'SurgemeActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'SurgemeActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.IrobMsgsSurgemeGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.IrobMsgsSurgemeGoalClass}, {'nonempty', 'scalar'}, 'SurgemeActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.IrobMsgsSurgemeGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.SurgemeActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.SurgemeActionGoal;
            obj.reload(strObj);
        end
    end
end
