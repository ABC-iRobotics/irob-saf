classdef SurgemeResult < robotics.ros.Message
    %SurgemeResult MATLAB implementation of irob_msgs/SurgemeResult
    ...
    properties (Constant)
        MessageType = 'irob_msgs/SurgemeResult' % The ROS message type
    end
    ...
    methods
        function obj = SurgemeResult(msg)
            %SurgemeResult Construct the message object SurgemeResult
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.IrobMsgsToolPoseClass}, {'nonempty', 'scalar'}, 'SurgemeResult', 'Pose');
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'SurgemeResult', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.SurgemeResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.SurgemeResult;
            obj.reload(strObj);
        end
    end
end
