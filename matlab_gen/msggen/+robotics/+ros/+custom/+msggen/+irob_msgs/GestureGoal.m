classdef GestureGoal < robotics.ros.Message
    %GestureGoal MATLAB implementation of irob_msgs/GestureGoal
    ...
    properties (Constant)
        MessageType = 'irob_msgs/GestureGoal' % The ROS message type
    end
    ...
    methods
        function obj = GestureGoal(msg)
            %GestureGoal Construct the message object GestureGoal
        ...
        function set.Action(obj, action)
            ...
            validateattributes(action, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'Action');
        ...
        function set.Target(obj, target)
            ...
            validateattributes(target, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'GestureGoal', 'Target');
        ...
        function set.Interpolation(obj, interpolation)
            ...
            validateattributes(interpolation, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'Interpolation');
        ...
        function set.ApproachPose(obj, approachpose)
            ...
            validateattributes(approachpose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'GestureGoal', 'ApproachPose');
        ...
        function set.TargetDiameter(obj, targetdiameter)
            ...
            validateattributes(targetdiameter, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'TargetDiameter');
        ...
        function set.CompressionRate(obj, compressionrate)
            ...
            validateattributes(compressionrate, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'CompressionRate');
        ...
        function set.Displacement(obj, displacement)
            ...
            validateattributes(displacement, {obj.GeometryMsgsPointClass}, {'nonempty', 'scalar'}, 'GestureGoal', 'Displacement');
        ...
        function set.SpeedCartesian(obj, speedcartesian)
            ...
            validateattributes(speedcartesian, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'SpeedCartesian');
        ...
        function set.SpeedJaw(obj, speedjaw)
            ...
            validateattributes(speedjaw, {'numeric'}, {'nonempty', 'scalar'}, 'GestureGoal', 'SpeedJaw');
        ...
        function set.Waypoints(obj, waypoints)
            ...
            validateattributes(waypoints, {obj.GeometryMsgsPoseClass}, {'vector'}, 'GestureGoal', 'Waypoints');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.GestureGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.GestureGoal;
            obj.reload(strObj);
        end
    end
end
