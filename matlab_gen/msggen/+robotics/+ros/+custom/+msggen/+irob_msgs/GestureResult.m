classdef GestureResult < robotics.ros.Message
    %GestureResult MATLAB implementation of irob_msgs/GestureResult
    ...
    properties (Constant)
        MessageType = 'irob_msgs/GestureResult' % The ROS message type
    end
    ...
    methods
        function obj = GestureResult(msg)
            %GestureResult Construct the message object GestureResult
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.IrobMsgsToolPoseClass}, {'nonempty', 'scalar'}, 'GestureResult', 'Pose');
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'GestureResult', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.GestureResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.GestureResult;
            obj.reload(strObj);
        end
    end
end
