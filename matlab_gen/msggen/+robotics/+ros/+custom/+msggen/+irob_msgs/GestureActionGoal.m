classdef GestureActionGoal < robotics.ros.Message
    %GestureActionGoal MATLAB implementation of irob_msgs/GestureActionGoal
    ...
    properties (Constant)
        MessageType = 'irob_msgs/GestureActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '5e13d7842570d742ce8e5083104f3f76' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsGestureGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/GestureGoal') % Dispatch to MATLAB class for message type irob_msgs/GestureGoal
    ...
    methods
        function obj = GestureActionGoal(msg)
            %GestureActionGoal Construct the message object GestureActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'GestureActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'GestureActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.IrobMsgsGestureGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.IrobMsgsGestureGoalClass}, {'nonempty', 'scalar'}, 'GestureActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.IrobMsgsGestureGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.GestureActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.GestureActionGoal;
            obj.reload(strObj);
        end
    end
end
