classdef RobotResult < robotics.ros.Message
    ...
    methods
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'RobotResult', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.RobotResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.RobotResult;
            obj.reload(strObj);
        end
    end
end
