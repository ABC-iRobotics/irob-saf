classdef RobotActionResult < robotics.ros.Message
    ...
    properties (Constant, Access = protected)
        ...
        IrobMsgsRobotResultClass = robotics.ros.msg.internal.MessageFactory.getClassForType('irob_msgs/RobotResult') % Dispatch to MATLAB class for message type irob_msgs/RobotResult
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.RobotActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.RobotActionResult;
            obj.reload(strObj);
        end
    end
end
