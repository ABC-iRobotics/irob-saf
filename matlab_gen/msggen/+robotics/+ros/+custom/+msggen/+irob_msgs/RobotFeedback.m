classdef RobotFeedback < robotics.ros.Message
    %RobotFeedback MATLAB implementation of irob_msgs/RobotFeedback
    ...
    properties (Constant)
        MessageType = 'irob_msgs/RobotFeedback' % The ROS message type
    end
    ...
    methods
        function obj = RobotFeedback(msg)
            %RobotFeedback Construct the message object RobotFeedback
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.IrobMsgsToolPoseClass}, {'nonempty', 'scalar'}, 'RobotFeedback', 'Pose');
        ...
        function set.Info(obj, info)
            ...
            validateattributes(info, {'char'}, {}, 'RobotFeedback', 'Info');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irob_msgs.RobotFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irob_msgs.RobotFeedback;
            obj.reload(strObj);
        end
    end
end
