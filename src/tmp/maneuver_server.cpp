...
ManeuverServer::ManeuverServer(ros::NodeHandle nh, std::string arm_name): 
 ...
 * Callbacks
 */
void ManeuverServer::initArmActionCB(const irob_autosurg::InitArmGoalConstPtr &goal)
{
    // helper variables
...
void ManeuverServer::resetPoseActionCB(const irob_autosurg::ResetPoseGoalConstPtr &goal)
{
    // helper variables
    bool success = false;
...
void ManeuverServer::followTrajectoryActionCB(
...
Pose ManeuverServer::getPoseCurrent()
{
 	ros::spinOnce();
