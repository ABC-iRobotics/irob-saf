...
namespace saf {
    ...
    ToolPose(const irob_msgs::msg::ToolPose&);
    ToolPose(const irob_msgs::msg::ToolPoseStamped&);
...
template <>
inline ToolPose unwrapMsg(const irob_msgs::msg::ToolPose& msg){
  ToolPose ret(msg);
  return ret;
}

template <>
inline ToolPose unwrapMsg(const irob_msgs::msg::ToolPoseStamped& msg){
  ToolPose ret(msg);
  return ret;
}

template <>
inline irob_msgs::msg::ToolPose wrapToMsg(const ToolPose& data){
