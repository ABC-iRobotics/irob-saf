...
#ifndef IROB_TRAJECTORY_FACTORY_HPP_
#define IROB_TRAJECTORY_FACTORY_HPP_

#include <iostream>
#include <vector>
#include <cmath>
#include <memory>  // For std::shared_ptr (used in ROS2)
#include <Eigen/Dense>
...
#include "rclcpp/rclcpp.hpp"  // ROS2 base include
...
public:
  ...
  /**
   *	Smoothly accelerating trajectory between 2 points.
   */
  template <class P>
  ...
  /**
     *	Smoothly accelerating trajectory between 2 points with waypoints.
     */
  template <class P>
  static Trajectory<P> linearTrajectoryWithSmoothAcceleration(
      P start,
...
#endif  // IROB_TRAJECTORY_FACTORY_HPP_
