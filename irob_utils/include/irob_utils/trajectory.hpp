...
#include <irob_msgs/msg/trajectory_tool_pose.hpp>  // ROS 2 message include
...
public:
  ...
  Trajectory(const irob_msgs::msg::TrajectoryToolPose&); // ROS 2 message
  void clear();
  void addPoint(T);
  ...
  void copyToRosTrajectory(irob_msgs::msg::TrajectoryToolPose&); // ROS 2 message
...
template <class T>
Trajectory<T>::Trajectory(const irob_msgs::msg::TrajectoryToolPose& msg)
{
